...
class Hierarchy extends DataExtension {
	...
	*/
	 ...
	 * @param boolean $calculateLinks Calculate links on the fly to avoid re-traversing ancestors each time
	 * @return ArrayList
	 */
	public function Children($calculateLinks = false) {
		if(!(isset($this->_cache_children) && $this->_cache_children)) {
			if (!$this->owner->canView()) {
				...
				if ($calculateLinks !== false) {
					$this->_cache_children = $this->add_cached_links_to_children($this->_cache_children);
				}
			}
		} 
